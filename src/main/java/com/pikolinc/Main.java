...
import com.pikolinc.routes.OfferApiRoutes;
...
public class Main {
    public static void main(String[] args) {
        ...
        List<Router> routes = List.of(
                ...
                new OfferApiRoutes(new OfferController(new OfferServiceImpl(new JdbiOfferRepository(jdbiProvider)), new GsonProvider()))
        );
